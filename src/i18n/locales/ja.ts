export default {
  basicInfo: {
    title: "基本情報",
    description:
      "あなたの基本情報を入力してください。これらの情報はあなただけのトーテムを生成するために使用されます",
    name: {
      label: "名前",
      required: "*",
    ...
    gender: {
      ...
      required: "*",
      description:
        "あなたに最も適したジェンダー特性を選択してください。これはトーテムの全体的なスタイルに影響を与えます",
      options: {
        yin: {
          label: "陰",
    ...
    bio: {
      ...
      required: "*",
      description:
        "あなたの性格、趣味、または願望を描写してください。これらはトーテムに組み込まれます",
    ...
    dimensions: {
      ...
      decisionMaking: {
        ...
        options: {
          thinking: {
            name: "思考型",
            traits: ["論理的分析に基づく", "客観性を追求", "真実を重視", "因果関係に注目"],
          },
          feeling: {
            name: "感情型",
            traits: ["価値観と感情に基づく", "他者の感情を考慮", "調和を重視", "影響を重視"],
          },
        },
      },
      lifestyle: {
        ...
        options: {
          judging: {
            name: "判断型",
            traits: ["計画と組織化を好む", "確実性を求める", "タスクを迅速に完了", "ルールに従う"],
          },
          perceiving: {
            name: "知覚型",
            traits: ["柔軟性と開放性を保つ", "適応力が高い", "状況に応じて対応", "可能性を探る"],
          },
        },
      },
    },

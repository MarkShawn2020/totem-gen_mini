export default {
  basicInfo: {
    ...
    description:
      "Please fill in your basic information, which will be used to generate your unique totem",
    name: {
      label: "Name",
      required: "*",
    ...
    gender: {
      ...
      required: "*",
      description:
        "Choose the gender characteristics that suit you best, this will affect the overall style of your totem",
      options: {
        yin: {
          label: "Yin",
    ...
    bio: {
      ...
      required: "*",
      description:
        "Describe your personality, hobbies, or aspirations, these will be incorporated into your totem",
